			...
			<Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }], flex: 1 }}>
				...
				>
							...
							>
								...
								>
									...
									>
										...
										<View style={styles.primaryActionTitleContainer}>
											<View
												style={[
													styles.primaryActionIcon,
													{ backgroundColor: themeColors.background },
										...
										<Text
											style={[
												...
												{ color: themeColors.background, opacity: 0.8 },
											]}
										>
					...
					<Animatable.View
						animation="fadeInUp"
						delay={800}
						style={styles.askAlexandriaContainer}
					>
						{/* Carved border container */}
						<View
							style={[
						...
						>
							<TouchableOpacity
								style={[
									styles.askAlexandriaButton,
									{ borderColor: themeColors.alexandriaGold, backgroundColor: "transparent" },
								]}
...
const styles = StyleSheet.create({
	...
	primaryAction: {
		borderRadius: 10, // Adjusted to fit within carved border (was 24)
		overflow: "hidden",
	},
