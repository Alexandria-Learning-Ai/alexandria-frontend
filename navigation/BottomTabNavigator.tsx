	...
	return (
		...
		>
			...
			>
				...
				{isFocused && (
					<Animated.View
						style={[
							...
							{
								opacity: glowOpacity,
								transform: [{ scale: glowScale }, { scale: breatheScale }],
							},
						]}
					>
						<LinearGradient
				...
				<Animated.View
					style={{
						transform: [{ scale: iconScale }, { rotate: rotateInterpolate }],
					}}
				>
					<FontAwesome5
						name={iconName}
...
const CustomTabBar = ({ state, descriptors, navigation }: any) => {
	...
	return (
		...
		>
			...
			{Platform.OS === "android" && <View style={styles.solidBackground} />}
			...
			<Animated.View style={{ opacity: borderOpacity }}>
				<LinearGradient
					colors={["rgba(212, 175, 55, 0.5)", "rgba(229, 193, 88, 0.3)", "rgba(212, 175, 55, 0.5)"]}
					start={{ x: 0, y: 0 }}
					end={{ x: 1, y: 0 }}
